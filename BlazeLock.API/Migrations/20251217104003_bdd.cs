        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    hash_masterkey = table.Column<byte[]>(type: "varbinary(50)", nullable: false),
                    salt = table.Column<byte[]>(type: "varbinary(50)", nullable: false),
                    id_utilisateur = table.Column<Guid>(type: "uniqueidentifier", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "id_coffre");
                    table.ForeignKey(
                        name: "FK_Log_Utilisateur_IdUtilisateur",
